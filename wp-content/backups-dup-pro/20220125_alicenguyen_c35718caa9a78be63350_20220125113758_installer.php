...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20220125_alicenguyen_c35718caa9a78be63350_20220125113758_archive.zip';
    const ARCHIVE_SIZE       = '64642550';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'c35718c-25113758';
    const SECONDARY_PACKAGE_HASH = 'db227e7-25113758';
    const VERSION            = '4.0.0';
    ...
    public function run()
    {
        ...
        $this->log('==DUPLICATOR INSTALLER BOOTSTRAP v4.0.0==');
        $this->log('----------------------------------------------------');
