                ...
                <tr class="<?php echo implode(' ', $rowClasses); ?>" id="duppro-packagerow-<?php echo $Package->ID; ?>">
                    ...
                    <td <?php echo $package_type_style; ?>>
                        ...
                        if ($isRecoveable) {
                            ...
                            ?>
                            <sup>&nbsp;&nbsp;<i class="dup-pro-recoveable-status fas fa-undo-alt" data-tooltip="<?php echo $title; ?>" ></i></sup>
                        <?php } ?>
                    ...
                    <td class="inst-name">
                        ...
                        <span data-dup-pro-copy-value="<?php echo $installerName; ?>" ><i class='far fa-copy' style='cursor: pointer'></i>
                    </td>
                    <td class="get-btns">
                        <!-- MENU DOWNLOAD -->
                            ...
                            <nav class="dpro-bar-menu-items">
                                ...
                                if ($isRecoveable) {
                                    ...
                                    <div class="dpro-btn-set-recovery" data-package-id="<?php echo $Package->ID; ?>">
                                        <span><i class="fas fa-undo-alt"></i> <?php DUP_PRO_U::esc_html_e("Set Recover Point") ?></span>
                                    </div>
                                    <?php
                                }
...
<?php $confirmRestoreBk->showConfirm(); ?>
        ...
        $('.dpro-btn-set-recovery').click(function () {
            DupPro.PackagesTable.find('.dpro-recovery-package').each(function () {
                ...
                $(this)
                        .find('.dup-pro-recoveable-status')
                        .qtip('option', 'content.text', <?php echo json_encode(DUP_PRO_U::__('Recovery Point Capable')); ?>);
            });
            ...
            DupPro.Pack.SetRecoveryPoint($(this).data('package-id'), function (funcData, data, textStatus, jqXHR) {
                ...
                newRecoveryRow
                        .find('.dup-pro-recoveable-status')
                        .qtip('option', 'content.text', <?php echo json_encode(DUP_PRO_U::__('Active Recovery Point')); ?>);
