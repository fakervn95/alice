...
<div class="dup-pro-recovery-point-selector">
    <?php if (empty($recoveablePackages)) { ?>
        <p class="dup-pro-notice">
            <i class="fa fa-info-circle"></i>
            <b><?php DUP_PRO_U::_e('Notice:'); ?></b>
            <?php DUP_PRO_U::_e('No recovery packages detected!'); ?><br/>
        </p>
        <div class="dup-pro-notice-details">
            <b><?php DUP_PRO_U::_e('How to resolve:'); ?></b>
            <ol class="dup-pro-simple-style-list" >
                ...
                <li>
                    <?php DUP_PRO_U::_e('On the packages screen click the package\'s details menu and select "Set Recovery Point".'); ?>
                </li>
                <li>
