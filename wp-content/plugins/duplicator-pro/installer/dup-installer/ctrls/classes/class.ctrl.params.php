...
final class DUPX_Ctrl_Params
{
    ...
    public static function setParamsStep1()
    {
        ...
        self::setPramasOnRestoreBackupMode();
    ...
    protected static function setPramasOnRestoreBackupMode()
    {
        $paramsManager = DUPX_Paramas_Manager::getInstance();
        ...
        if (DUPX_Custom_Host_Manager::getInstance()->isManaged()) {
            ...
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_WP_CONFIG, 'modify');
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_HTACCESS_CONFIG, 'original');
            $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_OTHER_CONFIG, 'original');
        }
        $paramsManager->setValue(DUPX_Paramas_Manager::PARAM_EMPTY_SCHEDULE_STORAGE, false);
    }
    ...
    protected static function setParamsDatabase()
    {
        ...
        $value     = DUPX_Paramas_Descriptor_database::getTableList($newPrefix, $subsiteId);
        if ($paramsManager->setValue(DUPX_Paramas_Manager::PARAM_DB_TABLES, $value) === false) {
            self::$paramsValidated = false;
        }
