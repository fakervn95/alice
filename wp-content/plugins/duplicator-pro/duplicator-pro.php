...
HTML;
    ...
    function duplicator_pro_menu()
    {
        ...
        if (!DUP_PRO_CTRL_import_installer::isDisallow()) {
            $page_installer = add_submenu_page(null, DUP_PRO_U::__('Install package'), '', $perms, DUP_PRO_Constants::$IMPORT_INSTALLER_PAGE, array('DUP_PRO_CTRL_import_installer', 'controller'));
        }
